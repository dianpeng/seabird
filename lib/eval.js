...
class Eval {
  ...
  _EvalPair(x) {
    return this._SetThis(new obj.Pair( this._EvalExpr(x.key) , this._EvalExpr(x.value) ));
  }
  ...
  _EvalLambdaCall(pos,lambda,frame,narg) {
    ...
    let result = this._SetThis(this._EvalExpr(lambda.code.body));
    ...
    if(x.op != lexer.Token.And && x.op != lexer.Token.Or) {
      ...
      switch(x.op) {
        ...
        case lexer.Token.Add:
          if(lhs instanceof obj.String && rhs instanceof obj.String) {
            return this._SetThis(new obj.String(lhs.value + rhs.value));
          }
      ...
      if(lval) {
        if(x.op == lexer.Token.Or)
          ...
          return this._SetThis(new obj.Boolean(obj.ToBoolean(this._EvalExpr(x.rhs))));
      } else {
  ...
  _EvalFunction(x) {
    return this._SetThis(new obj.Lambda(x));
  }
